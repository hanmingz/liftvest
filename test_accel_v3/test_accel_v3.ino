...
void loop()
{
  ...
  */
  ...
  if(trick == 0){
     digitalWrite(trickPin1, LOW);
     digitalWrite(trickPin2, HIGH);
     digitalWrite(trickPin3, HIGH);
   }

  else if(trick == 1){
    digitalWrite(trickPin1, HIGH);
    digitalWrite(trickPin2, LOW);
    digitalWrite(trickPin3, HIGH);
   }
...
// int sizeOfArr = 10;
// bool inMotion = false;
// int sensor1prev[sizeOfArr];
// int sensor2prev[sizeOfArr];
//
// int i;
// for (i = sizeOfArr-2; i>-1; i=i-1) {
//  sensor1prev[i+1] = sensor1prev[i];
//  sensor2prev[i+1] = sensor2prev[i];
// }
// sensor1prev[0] = y1;
// sensor2prev[0] = y2;
//
// int j;
// for (j = 0; j<sizeOfArr; j=j+1) {
////  Serial.print(sensor1prev[j]);
// }
//// Serial.println();
//
// int diff = abs(sensor1prev[sizeOfArr-1] - sensor1prev[0]);
//// Serial.println("difference is: ");
//// Serial.println(diff);
// int thresholdForMotion = 30;
// if (diff > thresholdForMotion) {
//  
//  inMotion = true;
// }
// else {
